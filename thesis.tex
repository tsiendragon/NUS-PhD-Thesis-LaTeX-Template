\documentclass[a4paper,11pt,twoside,loabychapter,lotbychapter,lofbychapter]{NusThesis}    
%% class option:
...
\supervisor{Associate Professor Chu Delin}     % Supervisor 
...
\pagestyle{empty}
\AddDeclaration[signature]% input tha fig name of your signature in the braket
...
\listofsymbols            % create the list of symbols and add to toc
\listofalgorithms\addcontentsline{toc}{chapter}{List of Algorithms}
\lstlistoflistings\addcontentsline{toc}{chapter}{List of Codes}
...
\addcontentsline{toc}{chapter}{Introduction} % add the introduction to toc
\input{introduction}     % introcution part
\pagestyle{basicstyle}   % use to change the head and foot style
...
% bibliography                                                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\bibliographystyle{tsien} % bibliography style, for example: plain
